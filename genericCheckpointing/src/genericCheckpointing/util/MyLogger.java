...
public class MyLogger {
  ...
  */
    ...
    public static enum DebugLevel {STRATEGY,FILE_GENERATE,FILE_PROCESSOR,NONE};
    ...
    public static void setDebugValue (int levelIn) {
        switch (levelIn) {
            case 2: debugLevel= DebugLevel.STRATEGY; break;
            case 1: debugLevel= DebugLevel.FILE_GENERATE; break;
